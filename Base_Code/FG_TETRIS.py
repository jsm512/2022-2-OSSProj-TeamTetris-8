...
class ui_variables:
    # Fonts
    font_path = "2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/fonts/a옛날사진관3.ttf"
    font_path_b = "2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/fonts/a옛날사진관3.ttf"
    font_path_i = "2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/fonts/a옛날사진관3.ttf"
    ...
    # Sounds
    pygame.mixer.music.load("2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/sounds/BGM1.wav")  # 음악 불러옴
    pygame.mixer.music.set_volume(0.5)  # 이 부분도 필요 없음, set_volume에 추가해야 함
    intro_sound = pygame.mixer.Sound("2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/sounds/intro.wav")
    fall_sound = pygame.mixer.Sound("2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/sounds/SFX_Fall.wav")
    break_sound = pygame.mixer.Sound("2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/sounds/SFX_Break.wav")
    click_sound = pygame.mixer.Sound("2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/sounds/SFX_ButtonUp.wav")  # 여기부터
    move_sound = pygame.mixer.Sound("2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/sounds/SFX_PieceMoveLR.wav")
    drop_sound = pygame.mixer.Sound("2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/sounds/SFX_PieceHardDrop.wav")
    single_sound = pygame.mixer.Sound(
        "2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/sounds/SFX_SpecialLineClearSingle.wav")
    double_sound = pygame.mixer.Sound(
        "2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/sounds/SFX_SpecialLineClearDouble.wav")
    triple_sound = pygame.mixer.Sound(
        "2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/sounds/SFX_SpecialLineClearTriple.wav")  # 여기까지는 기존코드
    tetris_sound = pygame.mixer.Sound("2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/sounds/SFX_SpecialTetris.wav")
    LevelUp_sound = pygame.mixer.Sound("2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/sounds/SFX_LevelUp.wav")
    GameOver_sound = pygame.mixer.Sound("2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/sounds/SFX_GameOver.wav")

    # 레벨업 이미지
    LevelUp_vector = pygame.image.load('2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/Level_Up.png')

    # # Combo graphic
    # combos = []
    # large_combos = []
    # combo_ring = pygame.image.load("2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/Combo/4combo ring.png")  # 4블록 동시제거 그래픽
    ...
    #     combos.append(pygame.image.load("2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/Combo/" + str(i) + "combo.png"))
    ...
    #     combos_sound.append(pygame.mixer.Sound("2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/sounds/SFX_" + str(i + 2) + "Combo.wav"))
    ...
    cyan_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/block_images/cyan.png'
    blue_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/block_images/blue.png'
    orange_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/block_images/orange.png'
    yellow_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/block_images/yellow.png'
    green_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/block_images/green.png'
    pink_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/block_images/purple.png'
    red_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/block_images/red.png'
    ghost_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/block_images/ghost.png'
    table_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/block_images/background.png'
    linessent_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/block_images/linessent.png'
...
# 각 이미지 주소
background_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/images/background_image.png'  # 메뉴화면(첫 화면) 배경
gamebackground_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/images/background_nyc.png'  # 게임 배경화면 : 기본값 뉴욕
pause_board_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/pause_board.png'

help_board_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/help_board.png'
select_mode_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/select_mode_button.png'
clicked_select_mode_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/clicked_select_mode_button.png'

setting_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/settings_button.png'
clicked_setting_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/clicked_settings_button.png'

pause_setting_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/pause_settings_button.png'
clicked_pause_setting_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/clicked_pause_settings_button.png'

score_board_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/score_board_button.png'
clicked_score_board_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/clicked_score_board_button.png'

quit_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/quit_button.png'
clicked_quit_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/clicked_quit_button.png'

resume_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/resume_button.png'
clicked_resume_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/clicked_resume_button.png'

help_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/help_button.png'
clicked_help_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/clicked_help_button.png'

single_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/easy_button.png'
clicked_single_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/clicked_easy_button.png'

hard_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/hard_button.png'
clicked_hard_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/clicked_hard_button.png'

pvp_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/multi_button.png'
clicked_pvp_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/clicked_multi_button.png'


hard_training_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/hard_tutorial_button.png'
clicked_hard_training_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/clicked_hard_tutorial_button.png'

multi_training_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/multi_tutorial_button.png'
clicked_multi_training_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/clicked_multi_tutorial_button.png'


gameover_board_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/gameover_board.png'

'''
help_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/help_button.png'
clicked_help_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/clicked_help_button.png'
gravity_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/gravity_button.png'
clicked_gravity_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/clicked_gravity_button.png'
setting_vector = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/setting_vector.png'
clicked_setting_vector = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/clicked_setting_vector.png'
setting_board_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/setting_board.png'
gameover_board_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/gameover_board.png'
gameover_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/gameover.png'
'''
hard_training_start_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/images/hard_tutorial_menual.png'
multi_training_start_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/images/multi_tutorial_menual.png'
setting_board_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/setting_board.png'
number_board = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/number_board.png'
mute_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/allmute_button.png'
clicked_mute_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/clicked_allmute_button.png'

background1_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/images/background_hongkong.png'
background2_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/images/background_nyc.png'
background3_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/images/background_uk.png'

clicked_background1_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/images/clicked_background_hongkong.png'
clicked_background2_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/images/clicked_background_nyc.png'
clicked_background3_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/images/clicked_background_uk.png'

mute_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/allmute_button.png'
default_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/default_button.png'
clicked_default_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/clicked_default_button.png'
number_board = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/number_board.png'

resume_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/resume_button.png'
clicked_resume_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/clicked_resume_button.png'
restart_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/restart_button.png'
clicked_restart_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/clicked_restart_button.png'

back_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/back_button.png'
clicked_back_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/clicked_back_button.png'
volume_vector = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/volume_vector.png'
clicked_volume_vector = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/clicked_volume_vector.png'
keyboard_vector = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/keyboard_vector.png'
clicked_keyboard_vector = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/clicked_keyboard_vector.png'
screen_vector = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/screen_vector.png'
clicked_screen_vector = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/clicked_screen_vector.png'
menu_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/menu_button.png'
clicked_menu_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/clicked_menu_button.png'
ok_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/ok_button.png'
clicked_ok_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/clicked_ok_button.png'
plus_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/plus_button.png'
clicked_plus_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/clicked_plus_button.png'
minus_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/minus_button.png'
clicked_minus_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/clicked_minus_button.png'

backgroundmusic_select_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/backgroundmusic_select.png'
clicked_backgroundmusic_select_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/clicked_backgroundmusic_select.png'
sound_off_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/sound_off_button.png'
sound_on_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/sound_on_button.png'
check_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/checkbox_button.png'
clicked_check_button_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/clicked_checkbox_button.png'

pvp_win_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/pvp_win.png'
pvp_lose_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/pvp_lose.png'
leaderboard_vector = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/leaderboard_vector.png'
clicked_leaderboard_vector = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/clicked_leaderboard_vector.png'
multi_win_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/multi_win.png'
multi_lose_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/multi_lose.png'
multi_game_over = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/multi_game_over.png'

leaderboard_vector = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/leaderboard_vector.png'
clicked_leaderboard_vector = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/clicked_leaderboard_vector.png'
scoreboard_board_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/score_board.png'

multi_gameover_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/multi_game_over.png'
multi_win_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/multi_win.png'
multi_lose_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/multi_lose.png'

multi_key_reverse_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/key_reverse.png'
hard_speed_up_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/speed_up.png'
hard_flipped_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/flipped.png'

multi_1P_break_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/images/multi_1p_break.png'
multi_2P_break_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/images/multi_2p_break.png'
training_box_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/box.png'

line_message_multi_break_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/line_message_multi_tutorial_break.png'
line_message_multi_win_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/line_message_multi_tutorial_win.png'

training_completed_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/images/training_completed.png'
training_incomplete_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/images/training_incomplete.png'

# 트레이닝모드 중간 이벤트 발생 시 나오는 설명 이미지
hard_3line_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/images/hard_3line.png'  # 하드트레이닝 3줄 제거시 등장
hard_10s_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/images/hard_10s.png'  # 하드트레이닝 10초 경과시 등장
hard_line_message = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/vector/line_message_hard_tutorial.png'  # 하드트레이닝 시작하자마자 메시지 등장
...
# 선택된 BGM
selected_bgm = "2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/sounds/BGM1.wav"
...
def set_initial_values():
    ...
    with open('2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/leaderboard.txt') as f:
        lines = f.readlines()
    lines = [line.rstrip('\n') for line in open(
        '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/leaderboard.txt')]  # leaderboard.txt 한줄씩 읽어옴
    ...
    with open('2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/leaderboard_hard.txt') as h:
        lines = h.readlines()
    lines = [line.rstrip('\n') for line in open(
        '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/leaderboard_hard.txt')]  # leaderboard.txt 한줄씩 읽어옴
        ...
        for event in pygame.event.get():
            ...
            if event.type == QUIT:
                ...
                if background1_check_button.isOver(pos):
                    gamebackground_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/images/background_hongkong.png'
                    # 클릭한 이미지에만 체크 표시
                ...
                if background2_check_button.isOver(pos):
                    gamebackground_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/images/background_nyc.png'
                    # 클릭한 이미지에만 체크 표시
                ...
                if background3_check_button.isOver(pos):
                    gamebackground_image = '2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/images/background_uk.png'
                    # 클릭한 이미지에만 체크 표시
                    background1_check_button.image = background1_image
                    background2_check_button.image = background2_image
        ...
        for event in pygame.event.get():
            ...
            if event.type == QUIT:
                ...
                if BGM1_sound_on_button.isOver(pos):
                    #ui_variables.intro_sound.("2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/sounds/BGM2.wav")#
                    # 클릭한 버튼만 체크 표시되도록
                ...
                if BGM2_sound_on_button.isOver(pos):
                    ...
                    ui_variables.intro_sound.stop()
                    pygame.mixer.music.stop()
                    selected_bgm = "2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/sounds/BGM2.wav"
                    pygame.mixer.music.load(selected_bgm)
                    pygame.mixer.music.play()
                if BGM3_sound_on_button.isOver(pos):
                    ...
                    ui_variables.intro_sound.stop()
                    pygame.mixer.music.stop()
                    selected_bgm = "2022-2-OSSPROJ-TEAMTETRIS-8/Base_Code/assets/sounds/BGM3.wav"
                    pygame.mixer.music.load(selected_bgm)
                    pygame.mixer.music.play()
