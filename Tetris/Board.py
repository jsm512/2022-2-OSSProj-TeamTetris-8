...
class Board:
    ...
    def delete_lines(self):
        ...
        for y in remove:
            line_sound = pygame.mixer.Sound("PROJECT_TETRIS/2022-2-OSSProj-TeamTetris-8/Tetris/assets/sounds/Line_Clear.wav")
            line_sound.play()
            self.delete_line(y)
    ...
    def draw(self):
        ...
        next_text = pygame.font.Font('2022-2-OSSProj-TeamTetris-8/Tetris/assets/fonts/Roboto-Bold.ttf', 18).render('NEXT', True, BLACK)
        skill_text = pygame.font.Font('2022-2-OSSProj-TeamTetris-8/Tetris/assets/fonts/Roboto-Bold.ttf', 18).render('SKILL', True, BLACK)
        skill_value = pygame.font.Font('2022-2-OSSProj-TeamTetris-8/Tetris/assets/fonts/Roboto-Bold.ttf', 16).render(str(self.skill)+'%', True, BLACK)
        score_text = pygame.font.Font('2022-2-OSSProj-TeamTetris-8/Tetris/assets/fonts/Roboto-Bold.ttf', 18).render('SCORE', True, BLACK)
        score_value = pygame.font.Font('2022-2-OSSProj-TeamTetris-8/Tetris/assets/fonts/Roboto-Bold.ttf', 16).render(str(self.score), True, BLACK)
        level_text = pygame.font.Font('2022-2-OSSProj-TeamTetris-8/Tetris/assets/fonts/Roboto-Bold.ttf', 18).render('LEVEL', True, BLACK)
        level_value = pygame.font.Font('2022-2-OSSProj-TeamTetris-8/Tetris/assets/fonts/Roboto-Bold.ttf', 16).render(str(self.level), True, BLACK)
        goal_text = pygame.font.Font('2022-2-OSSProj-TeamTetris-8/Tetris/assets/fonts/Roboto-Bold.ttf', 18).render('GOAL', True, BLACK)
        goal_value = pygame.font.Font('2022-2-OSSProj-TeamTetris-8/Tetris/assets/fonts/Roboto-Bold.ttf', 16).render(str(self.goal), True, BLACK)
        time_text = pygame.font.Font('2022-2-OSSProj-TeamTetris-8/Tetris/assets/fonts/Roboto-Bold.ttf', 14).render(str(nowTime), True, BLACK)
    ...
    def pause(self):
        fontObj = pygame.font.Font('2022-2-OSSProj-TeamTetris-8/Tetris/assets/fonts/Roboto-Bold.ttf', 32)
        textSurfaceObj = fontObj.render('Paused', True, GREEN)
        textRectObj = textSurfaceObj.get_rect()
        textRectObj.center = (175, 185)
        fontObj2 = pygame.font.Font('2022-2-OSSProj-TeamTetris-8/Tetris/assets/fonts/Roboto-Bold.ttf', 16)
...
##궁극기
    def ultimate(self):
        if self.skill == 100:
            bomb = pygame.image.load("2022-2-OSSProj-TeamTetris-8/Tetris/assets/vector/bomb.jpg")
            bomb = pygame.transform.scale(bomb, (350, 450))
            bomb_sound = pygame.mixer.Sound('2022-2-OSSProj-TeamTetris-8/Tetris/assets/sounds/bomb.wav')
